    ...
    <div className="flex justify-center items-center min-h-screen bg-gray-50 p-4">
      <div className="w-full max-w-md bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <div className="flex border-b">
          <button className={`flex-1 py-4 text-center font-medium ${activeTab === "login" ? "text-blue-500 border-b-2 border-blue-500" : "text-gray-400"}`} onClick={() => handleTabSwitch("login")}>
            Log in
          </button>
          <button className={`flex-1 py-4 text-center font-medium ${activeTab === "signup" ? "text-blue-500 border-b-2 border-blue-500" : "text-gray-400"}`} onClick={() => handleTabSwitch("signup")}>
            Create Account
          </button>
        </div>
          ...
          <div className="mt-6 text-center">
            {activeTab === "signup" ? (
              <p className="text-gray-600">
                ...
                <button onClick={() => handleTabSwitch("login")} className="text-blue-500 hover:underline">
                  sign in
                </button>
              </p>
            ) : (
              <p className="text-gray-600">
                ...
                <button onClick={() => handleTabSwitch("signup")} className="text-blue-500 hover:underline">
                  sign up
                </button>
              </p>
            )}
